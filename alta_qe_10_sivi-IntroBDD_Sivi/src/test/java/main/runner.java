...
public class runner extends JUnitStories {
    ...
    public InjectableStepsFactory stepsFactory() {
        return new InstanceStepsFactory(configuration(), new loginsteps(), new registersteps(), new searchcolleaguesteps()); //untuk memanggil stepnya
    }
    ...
    protected List<String> storyPaths(){
        return Arrays.asList("login.story", "register.story", "searchcolleague.story");
    }
}
